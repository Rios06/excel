        ...
        try {
            ...
            for (Row row : sheet) {
                if (row.getCell(0) != null && row.getCell(1) != null && row.getCell(2) != null && row.getCell(3) != null && row.getCell(4) != null && row.getCell(5) != null && row.getCell(6) != null) {
                    ...
                    int edad = (int) row.getCell(2).getNumericCellValue();
                    String direccion = row.getCell(3).getStringCellValue();
                    long numeroContacto = (long) row.getCell(4).getNumericCellValue();
                    String rol = row.getCell(5).getStringCellValue();
                    String fechaContratacion = row.getCell(6).getStringCellValue();
